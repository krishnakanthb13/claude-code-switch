...
graph TD
    ...
    C -->|any profile in profiles/| E[Copy profiles/NAME.json to settings.json]
...
- **Dynamic Usage Help**: If no profile argument is specified, it dynamically scans the `%USERPROFILE%\.claude\profiles\` directory to construct and print a usage message showing all currently available profiles.
